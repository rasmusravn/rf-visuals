...
Welcome to the contributor guide of rf-visuals.
...
If you experience bugs or general issues with rf-visuals, please have a look
...
You can help improve the documentation of rf-visuals by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/rf-visuals.git
   cd rf-visuals
   ```
